...
import com.example.ApiDemo.filter.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    @Autowired
    public SecurityConfig(UsersDetailsServiceImplementation usersDetailsServiceImplementation, JwtAuthFilter jwtAuthFilter) {
